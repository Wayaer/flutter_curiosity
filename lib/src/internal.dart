...
class Internal {
  ...
  static const String curiosityEvent = 'curiosity/event';

  static const MethodChannel curiosityChannel = MethodChannel(curiosity);
  ...
  static bool get supportPlatformDesktop {
    if (!isWeb && isDesktop) return true;
    log('Curiosity is not support Platform');
    return false;
  }

  static bool get supportPlatform {
    if (!isWeb && (isMobile || isMacOS)) return true;
    log('Curiosity is not support Platform');
    return false;
  }

  static bool get supportPlatformMobile {
...
extension ExtensionMacOSSettingPath on MacOSSettingPath {
